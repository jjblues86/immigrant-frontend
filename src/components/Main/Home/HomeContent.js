        ...
        <Fragment>
            ...
            <div className="box cta">
                <p className="has-text-black-bis has-text-justified is-size-5-widescreen has-text-weight-normal is-family-monospace">
                    ...
                    Here you'll get to read about an immigrant's story and experience the diverse backgrounds of many who gave up everything they knew from their origin countries to pursue a dream of becoming successful in the western world. Most of these immigrants are your Doctors, lawyers, nurses, teachers to name a few.
                </p>
            </div>
        </Fragment>
    )
